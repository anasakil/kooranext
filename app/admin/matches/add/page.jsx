...
const AddMatchPage = () => {
    ...
    const handleSubmit = async (values) => {
        ...
        if (teamAImg) formData.append('teamAImg', teamAImg);
        if (teamBImg) formData.append('teamBImg', teamBImg);
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
            ...
            >
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <Form.Item label="Team A" name="teamA" rules={[{ required: true, message: 'Please input Team A name' }]}>
                            <Input placeholder="Enter Team A" />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                        <Form.Item label="Team B" name="teamB" rules={[{ required: true, message: 'Please input Team B name' }]}>
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <Form.Item label="Status" name="status" rules={[{ required: true, message: 'Please select match status' }]}>
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <Form.Item label="Match Date" name="matchDate" rules={[{ required: true, message: 'Please select match date' }]}>
                            <DatePicker style={{ width: '100%' }} />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                        <Form.Item label="Tournament" name="tournament" rules={[{ required: true, message: 'Please input tournament name' }]}>
